...
export const OutputDashboard: React.FC<OutputDashboardProps> = ({
  ...
  return (
    <section className="py-8 sm:py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="bg-[#0D1322]/90 border border-[#1E293B] rounded-2xl p-6 shadow-2xl space-y-6 relative overflow-hidden">
        
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="space-y-2 max-w-3xl">
            <div className="flex items-center gap-2 flex-wrap text-xs">
              <span className="px-2.5 py-0.5 rounded-full bg-[#00F2FE]/10 text-[#00F2FE] border border-[#00F2FE]/30 font-bold uppercase tracking-wider">
                Nyoria Study Pack
              </span>
              <span className="px-2.5 py-0.5 rounded-full bg-[#090D16] text-slate-400 border border-[#1E293B] font-semibold">
                Difficulty: {kit.difficulty}
              </span>
          ...
          <div className="flex items-center gap-2 flex-wrap no-print">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all ${
                isSavedInLibrary
                  ...
                  : 'bg-gradient-to-r from-[#00F2FE] to-[#4FACFE] text-[#090D16] font-black shadow-md shadow-[#00F2FE]/20'
              }`}
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-[#090D16] hover:bg-[#1E293B] text-slate-200 text-xs sm:text-sm font-semibold border border-[#1E293B] transition-colors shadow-sm"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-xl bg-[#090D16] border border-[#1E293B]">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs font-semibold">
              ...
              <span className="font-mono text-slate-400">
                <strong className="text-[#10B981]">{correctMCQsCount} / {solvedMCQs.length} Correct</strong> ({accuracyPercentage}%)
              </span>
            </div>
            <div className="w-full h-2.5 bg-[#0D1322] rounded-full overflow-hidden">
              <div
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs font-semibold">
              ...
              <span className="font-mono text-slate-400">
                <strong className="text-[#00F2FE]">{masteredCount} / {totalQuestions} Topics</strong> ({overallMasteryPercentage}%)
              </span>
            </div>
            <div className="w-full h-2.5 bg-[#0D1322] rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-[#00F2FE] to-[#10B981] transition-all duration-500 rounded-full"
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-[#1E293B] pb-4 no-print">
        ...
        {/* Navigation Tabs */}
        <div className="flex items-center gap-1.5 bg-[#0D1322] p-1.5 rounded-xl border border-[#1E293B] overflow-x-auto w-full sm:w-auto">
          {[
            ...
            >
              ...
              <span className={`px-1.5 py-0.2 rounded-full text-[10px] ${
                activeTab === tab.id ? 'bg-[#090D16] text-[#00F2FE]' : 'bg-[#090D16] text-slate-400'
              }`}>
                {tab.count}
              </span>
            </button>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <div className="relative flex-1 sm:w-64">
            <input
              ...
              className="w-full px-3 py-1.5 rounded-xl bg-[#090D16] border border-[#1E293B] text-slate-200 placeholder-slate-500 text-xs focus:outline-none focus:ring-2 focus:ring-[#00F2FE]/50"
            />
          </div>
          ...
          <select
            ...
            className="px-3 py-1.5 rounded-xl bg-[#090D16] border border-[#1E293B] text-slate-300 text-xs focus:outline-none"
          >
        ...
        {(activeTab === 'all' || activeTab === 'mcq' || activeTab === 'accordions') && (
          <div className="space-y-4">
            ...
            {filteredQuestions.length === 0 ? (
              <div className="p-8 text-center bg-[#0D1322] border border-[#1E293B] rounded-2xl text-slate-400 text-xs">
