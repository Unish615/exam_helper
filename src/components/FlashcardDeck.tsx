  ...
  return (
    <div className="bg-[#111827]/90 border border-[#1E293B] rounded-2xl p-5 sm:p-7 space-y-6 shadow-xl relative overflow-hidden">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1 rounded-xl bg-[#1E293B] hover:bg-slate-700 text-slate-300 text-xs font-bold border border-slate-700 transition-colors"
            title="Shuffle deck"
          >
            Shuffle Deck
          </button>
      ...
      <div className="flex items-center justify-center gap-4 pt-2">
        <button
          onClick={handlePrev}
          className="px-4 py-2.5 rounded-xl bg-[#1E293B] hover:bg-slate-700 text-slate-200 font-semibold text-xs sm:text-sm border border-slate-700 transition-all shadow-md"
        >
          ← Previous Card
        </button>
